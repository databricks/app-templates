...
class ProcessManager:
    ...
    def check_ports(self):
        ...
        if not self.no_ui:
            if backend_port == self.frontend_port:
                print(
            ...
            if not check_port_available(self.frontend_port):
                port_source = (
                    "CHAT_APP_PORT"
                ...
                errors.append(
                    f"Port {self.frontend_port} (frontend, source: {port_source}) is already in use.\n"
                    f"  To free it: lsof -ti :{self.frontend_port} | xargs kill -9\n"
            ...
            for line in iter(process.stdout.readline, ""):
                ...
                if not is_ready and any(re.search(p, line, re.IGNORECASE) for p in patterns):
                    ...
                    if self.no_ui and self.backend_ready:
                        ...
                        print(f"✓ Open the frontend at http://localhost:{self.frontend_port}")
                        print("=" * 50 + "\n")
