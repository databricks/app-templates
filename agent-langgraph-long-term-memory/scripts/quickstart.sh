...
echo "==================================================================="
echo
echo "To test long-term memory locally, include a user_id in your requests:"
echo "  curl -X POST http://localhost:8000/invocations \\"
echo "    -H 'Content-Type: application/json' \\"
echo "    -d '{\"input\": [{\"role\": \"user\", \"content\": \"hi\"}], \"context\": {\"user_id\": \"test@example.com\"}}'"
echo
