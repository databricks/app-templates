...
databricks bundle deployment bind agent_langgraph_short_term_memory <existing-app-name> --auto-approve
```
...
```bash
databricks bundle deployment unbind agent_langgraph_short_term_memory
```
