...
This 6-configuration matrix covers the sweet spot identified from prior testing. For broader coverage, you can add additional configurations (for example, Medium w6/w8 or Large w12).
