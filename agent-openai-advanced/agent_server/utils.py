...
def init_lakebase_config() -> tuple[str | None, str | None, str | None]:
    """Read lakebase env vars and return (instance_name, project, branch).

    Validates that at least one mode (provisioned or autoscaling) is configured.
    """
    ...
    return instance_name, project, branch
