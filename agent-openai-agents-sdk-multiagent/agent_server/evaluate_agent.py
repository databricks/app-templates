...
# TODO: Update with evaluation examples relevant to your configured backends
eval_dataset = [
    {
        "inputs": {
            "request": {
                "input": [{"role": "user", "content": "What data sources are available to you?"}]
            }
        },
        "expected_response": "I can query a Genie space for structured data, a specialist app agent, a knowledge assistant, and a model serving endpoint.",
    }
]
