...
export interface PositionLeftIconProps extends React.SVGProps<SVGSVGElement> {
...
export const PositionLeftIcon = forwardRef<SVGSVGElement, PositionLeftIconProps>(
