...
export interface CaretDownSquareIconProps extends React.SVGProps<SVGSVGElement> {
...
export const CaretDownSquareIcon = forwardRef<SVGSVGElement, CaretDownSquareIconProps>(
