...
export interface CloudDatabaseIconProps extends React.SVGProps<SVGSVGElement> {
...
export const CloudDatabaseIcon = forwardRef<SVGSVGElement, CloudDatabaseIconProps>(
