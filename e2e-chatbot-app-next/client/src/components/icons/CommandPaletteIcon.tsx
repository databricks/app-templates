...
export interface CommandPaletteIconProps extends React.SVGProps<SVGSVGElement> {
...
export const CommandPaletteIcon = forwardRef<SVGSVGElement, CommandPaletteIconProps>(
