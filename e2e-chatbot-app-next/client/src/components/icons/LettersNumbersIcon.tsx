...
export interface LettersNumbersIconProps extends React.SVGProps<SVGSVGElement> {
...
export const LettersNumbersIcon = forwardRef<SVGSVGElement, LettersNumbersIconProps>(
