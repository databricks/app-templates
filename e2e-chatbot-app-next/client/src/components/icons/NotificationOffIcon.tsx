...
export interface NotificationOffIconProps extends React.SVGProps<SVGSVGElement> {
...
export const NotificationOffIcon = forwardRef<SVGSVGElement, NotificationOffIconProps>(
