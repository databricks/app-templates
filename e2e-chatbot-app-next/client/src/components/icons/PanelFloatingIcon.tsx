...
export interface PanelFloatingIconProps extends React.SVGProps<SVGSVGElement> {
...
export const PanelFloatingIcon = forwardRef<SVGSVGElement, PanelFloatingIconProps>(
