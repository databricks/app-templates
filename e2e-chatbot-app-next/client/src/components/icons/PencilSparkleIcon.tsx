...
export interface PencilSparkleIconProps extends React.SVGProps<SVGSVGElement> {
...
export const PencilSparkleIcon = forwardRef<SVGSVGElement, PencilSparkleIconProps>(
