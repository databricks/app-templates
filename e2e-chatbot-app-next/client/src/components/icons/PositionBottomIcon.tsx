...
export interface PositionBottomIconProps extends React.SVGProps<SVGSVGElement> {
...
export const PositionBottomIcon = forwardRef<SVGSVGElement, PositionBottomIconProps>(
