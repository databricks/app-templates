...
export interface SparkleDoubleIconProps extends React.SVGProps<SVGSVGElement> {
...
export const SparkleDoubleIcon = forwardRef<SVGSVGElement, SparkleDoubleIconProps>(
