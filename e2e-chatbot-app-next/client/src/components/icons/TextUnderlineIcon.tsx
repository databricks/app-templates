...
export interface TextUnderlineIconProps extends React.SVGProps<SVGSVGElement> {
...
export const TextUnderlineIcon = forwardRef<SVGSVGElement, TextUnderlineIconProps>(
