...
export interface WrenchSparkleIconProps extends React.SVGProps<SVGSVGElement> {
...
export const WrenchSparkleIcon = forwardRef<SVGSVGElement, WrenchSparkleIconProps>(
