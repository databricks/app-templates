...
**Clone the template into `migrated_app/`:**
...
# Move/rename the template to migrated_app
cd ..
mv app-templates/<template-name> ./migrated_app
rm -rf app-templates
```

Or copy from an existing local clone of app-templates into `./migrated_app/`.
